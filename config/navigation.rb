...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :key_5, 'Administration' , '/admin', :icon => 'icon-cog' do |sub_nav|
      ...
      sub_nav.item :key_5_15, 'Gérer les accompagnateurs', new_admin_accompanist_path
      sub_nav.item :key_5_16, 'Gérer les juges', new_admin_juge_path
      sub_nav.item :key_5_17, 'Gérer les professeurs', new_admin_teacher_path
      sub_nav.item :key_5_18,'', nil, :class=> 'divider'
      sub_nav.item :key_5_19,'Inviter un utilisateur', '/users/invitation/new'
      sub_nav.item :key_5_20,'Gérer les utilisateurs', new_admin_user_path
    end
