...
category5 = Category.create(name: 'Ensemble',		group:true , 	nb_participants:01, accompanyist:false,	description:"Les ensembles devront être composés d’un maximum de 12 musiciens et/ou chanteurs. Les participants peuvent présenter une ou deux pièces. L’ensemble vocal peut présenter une à cinq pièces.")
