...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :key_5, 'Administration' , '/admin', :icon => 'icon-cog' do |sub_nav|
      ...
      sub_nav.item :key_5_10, 'Gérer les types d\'écoles', new_admin_schooltype_path
      sub_nav.item :key_5_11, 'Gérer les villes', new_admin_city_path
      sub_nav.item :key_5_12,'', nil, :class=> 'divider'
      sub_nav.item :key_5_13, 'Gérer les accompagnateurs', new_admin_accompanist_path
      sub_nav.item :key_5_14, 'Gérer les juges', new_admin_juge_path
      sub_nav.item :key_5_15, 'Gérer les professeurs', new_admin_teacher_path
      sub_nav.item :key_5_16,'', nil, :class=> 'divider'
      sub_nav.item :key_5_17,'Inviter un utilisateur', '/users/invitation/new'
      sub_nav.item :key_5_18,'Gérer les utilisateurs', new_admin_user_path
    end
