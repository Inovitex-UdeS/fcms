...
registration2 = Registration.create(user_teacher_id: user2.id, user_owner_id: user4.id, school_id: school1.id, edition_id: edition1.id, category_id: category1.id, duration: 5)
registration3 = Registration.create(user_teacher_id: user2.id, user_owner_id: user4.id, school_id: school1.id, edition_id: edition1.id, category_id: category1.id, duration: 5)
registration4 = Registration.create(user_teacher_id: user2.id, user_owner_id: user4.id, school_id: school1.id, edition_id: edition1.id, category_id: category1.id, duration: 5)
